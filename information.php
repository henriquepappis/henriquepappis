<aside class="info aside section">  
    <div class="section-inner">
        <h2 class="heading"><?php echo $titleInformation; ?></h2>
        <div class="content">
            <ul class="list-unstyled">
                <li><i class="fa fa-map-marker"></i><span class="sr-only">Location:</span><?php echo $city.", ".$country; ?></li>
                ...
                <li><i class="fa fa-envelope-o"></i><span class="sr-only">Email:</span><a href="#">contact@henriquepappis.com</a></li>
